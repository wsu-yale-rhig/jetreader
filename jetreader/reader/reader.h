...
public:
  ...
  // criteria. If loading is successful, returns true, otherwise, returns false.
  // Will raise an exception for attempted out-of-bounds access.
...
private:
  ...
  // processes tracks and tower hits into pseudojets
  void selectTracks();
  void selectTowers();
